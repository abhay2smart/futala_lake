                                ...
                                VStack {
                                    ...
                                    if bookingData.seatDetails?[index].seatInfo?.adultQuantity ?? 0 > 0 {
                                        HStack {
                                            ...
                                            Text("\(bookingData.seatDetails?[index].seatInfo?.adultQuantity ?? 0) / ₹ \(bookingData.seatDetails?[index].seatInfo?.adultFare ?? 0)")
                                    ...
                                    if bookingData.seatDetails?[index].seatInfo?.childQuantity ?? 0 > 0 {
                                        HStack {
                                            ...
                                            Text("\(bookingData.seatDetails?[index].seatInfo?.childQuantity ?? 0) / ₹ \(bookingData.seatDetails?[index].seatInfo?.childFare ?? 0)")
